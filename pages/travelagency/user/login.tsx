    ...
    <div className='p-16'>
        <div className='p-4 bg-neutral-800 rounded-2xl flex flex-col space-y-4 '>
            <div className='flex justify-evenly'>
                <button onClick={() => router.push("/travelagency/user/signup")} className={`text-slate-300 font-semibold`}>User Sign Up</button>
                <button className={`text-sky-500 font-semibold`}>User Login</button>
            </div>
