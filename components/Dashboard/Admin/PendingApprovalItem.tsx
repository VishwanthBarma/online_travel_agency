...
function PendingApprovalItem({data, index}: any) {
    ...
    <div className='flex flex-col border-b-2 border-neutral-900'>
        <div className='flex items-center p-2 font-medium'>
...

            {
                ...
                :
                <button onClick={handleApprove} disabled={isLoading} className='w-1/6 bg-green-500 p-1 rounded-lg font-bold text-neutral-900 flex items-center justify-center'>
                    {isLoading ? 
                        (<svg
